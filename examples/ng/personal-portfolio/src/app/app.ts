...
@Component({
  ...
  template: `
    ...
    <div
      class="fixed top-6 right-6 z-50 flex gap-4 rounded-full border border-slate-700/50 bg-slate-900/40 px-4 py-2 text-sm font-medium shadow-xl backdrop-blur-md"
    >
