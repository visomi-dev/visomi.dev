# DESIGN CONSTRAINT BLOCK

## 1. Core Identity

This website represents a systems-oriented senior engineer.
...
## 2. Aesthetic Constraints (Non-Negotiable)
...
## 3. Conceptual Influences (Subtle, Not Literal)
...
* Influence from RPG system design (medieval or futuristic).
  ...
  → System-like composition.

Do NOT use fantasy imagery or literal space themes.
This is conceptual, not decorative.
