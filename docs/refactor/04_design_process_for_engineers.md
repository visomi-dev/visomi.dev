...
**Key Concepts:**
* **Wireframes:** Black and white (or grayscale) drawings using only rectangles and basic text to define *where* everything goes, without colors, final typography, or animations. This ensures the structure works before investing time in painting.
...
* **Micro-interactions:** Designing what happens when you *hover*, *focus*, or *click* on an element.
