      ...
      experience: [
        {
          ...
          items: [
            ...
            'Created reusable frontend and backend foundations that standardized delivery across teams and kept automation maintenance lightweight through configuration-driven updates.',
          ],
        },
        {
          company: 'Solidus Capital',
      ...
      experience: [
        {
          ...
          items: [
            ...
            'Cree bases reutilizables de frontend y backend para estandarizar la entrega entre equipos y mantener la automatizacion mediante actualizaciones ligeras basadas en configuracion.',
          ],
        },
        {
          company: 'Solidus Capital',
